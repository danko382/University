        ...
        \subsection{Глава 1}
            ...
            \subsubsection{Билет 1}
                ...
                \textbf{Определение противоположного события:}
                    ...
                    $A$ называется $\overline{A}$, которое
            ...
            \subsubsection{Билет 2}
                ...
                \textbf{Определение $\sigma$"=алгебры событий:}
                    ...
                    Сигма алгебра~--- это непустой класс
                    множества замкнутый относительно счётного
                    количества сумм и отрицаний и:

                    \begin{enumerate}
                        \item{если $A \in \mathfrak{F}$, то
                        $\overline{A} \in \mathfrak{F}$;}
                        \item{$\Omega \in \mathfrak{F}$;}
                        \item{если $\{A\}_{i = 1}^{\infty} \in$,
                        то $\bigcap_{i = 1}^{\infty} A_i \in 
                        \mathfrak{F}$.}
                    \end{enumerate}
                    \bigskip
            ...
            \subsubsection{Билет 3}
                ...
                \textbf{Определение конечной аддитивной
                вероятностной меры:}
                    \smallskip

                    Пусть $\mathfrak{A}$~--- алгебра множеств
                    из $\Omega$.

                    Конечной аддитивной вероятностой мерой
                    $Q(A)$ называется функция множества $Q:
                    A \rightarrow [0;1]$ такая, что 
                    
                    \[
                        \forall A \in \mathfrak{A}, \;\; Q(A)
                        \geq 0,
                    \]

                    \[
                        Q(\Omega) = 1, \;\; \forall A, B \in
                        \mathfrak{A}, \;\; A \cap B = \varnothing
                        \;\; Q(A \cup B) = Q(A) + Q(B)
                    \]
                ...
                вероятностной меры:}
                    ...
                    Счётно аддитивной вероятностной мерой $P(A)$
                    называется функция множества $P :
                    \mathfrak{A} \rightarrow [0;1]$ такая, что 

                    \[
                        \forall A \in \mathfrak{A} \;\; P(A) 
                        \geq 0, \;\; P(\Omega) = 1,
                    \]

                    \[
                        \forall \{A_i\}_{i = 1}^{\infty} \in
                        \mathfrak{A} \;\; \forall i \neq j \;\;
                        A_i \cap A_j = \varnothing \;\;
                        P(\bigsqcup_{i = 1}^{\infty} A_i) =
            ...
            \subsubsection{Билет 6}
                ...
                \textbf{Определение условной вероятности:}
                    ...
                    Пусть $(\Omega, \mathfrak{F}, P)$~--- 
                    вероятностное пространство и $A, B \in
                    \mathfrak{F}, \;\; P(B) > 0$. Условной
                ...
                \textbf{Теорема (формула полной вероятности):}
                    ...
                    $\{A_i\}_i^{\infty} \in \mathfrak{F}$~---
                    полная группа попарно несовметных событий;
                    $P(A_i) \geq 0$, пусть $A \in \mathfrak{F}$~---
