...
\begin{document}
    ...
    \section{Минимум 2}
        ...
        \subsection{Билет 5}
            ...
            распределения:}
                ...
                \begin{enumerate}
                    \item{$\forall x \in R \;\;\;\; f_{\xi}
                    (x) \geq 0$;}
                    \item{$F_{\xi}^{'}(x) = f_{\xi}(x)$ почти всегда;}
                    \item{$\int_{-\infty}^{\infty} f_{\xi}(x)
                    dx = 1$;}
        ...
        \subsection{Билет 7}
            ...
            \textbf{Свойствай математического ожидания:}
                ...
                \begin{enumerate}
                    ...
                    $M\xi \geq 0$;}
                    \item{Неравенство Коши"=Банюковского:
                    
                    \[
                        M|\xi\eta| \leq M|\xi|M|\eta|;  
                    \]
                    }
                    \item{Неравенство Чебушёва:
        ...
        \subsection{Билет 13}
            ...
            \textbf{Математическим ожиданием случайной величины $\xi_0 \sim N(0, 1)$:}
                \smallskip     
            
                \[
                    M\xi_0 = \int^{+\infty}_{-\infty} x e^{-\frac{x^2}{2}} dx =
                    \int^0_{-\infty} x e^{-\frac{x^2}{2}} dx +
                    \int^{+\infty}_{0} x e^{-\frac{x^2}{2}} dx
                \]
                \bigskip

            \textbf{Математическим ожиданием случайной величины $\xi \sim N(a,
            \sigma^2)$:}
                \smallskip     

                \[
                    M\xi_0 = \int^{+\infty}_{-\infty} x e^{-\frac{x^2}{2}} dx = 1
                \]
                \bigskip
